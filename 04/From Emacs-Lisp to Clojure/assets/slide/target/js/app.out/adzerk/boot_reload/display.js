...
return (function (p__7962){
var vec__7963 = p__7962;
var attr = cljs.core.nth.call(null,vec__7963,(0),null);
var v = cljs.core.nth.call(null,vec__7963,(1),null);
...
var args7964 = [];
var len__5964__auto___7967 = arguments.length;
var i__5965__auto___7968 = (0);
while(true){
if((i__5965__auto___7968 < len__5964__auto___7967)){
args7964.push((arguments[i__5965__auto___7968]));

var G__7969 = (i__5965__auto___7968 + (1));
i__5965__auto___7968 = G__7969;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args7964.length)].join('')));
...
var len__5964__auto___7972 = arguments.length;
var i__5965__auto___7973 = (0);
while(true){
if((i__5965__auto___7973 < len__5964__auto___7972)){
args__5971__auto__.push((arguments[i__5965__auto___7973]));

var G__7974 = (i__5965__auto___7973 + (1));
i__5965__auto___7973 = G__7974;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq7971){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq7971));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__7975){
var map__7979 = p__7975;
...
var data = map__7979__$1;
var message = cljs.core.get.call(null,map__7979__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__7979__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__7979__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__7981 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__7981,goog.events.EventType.CLICK,((function (G__7981,map__7979,map__7979__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__7981,map__7979,map__7979__$1,data,message,line,file))
);

return G__7981;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__7982){
var map__7986 = p__7982;
var map__7986__$1 = ((((!((map__7986 == null)))?((((map__7986.cljs$lang$protocol_mask$partition0$ & (64))) || (map__7986.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7986):map__7986);
var data = map__7986__$1;
var message = cljs.core.get.call(null,map__7986__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__7986__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__7986__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__7988 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),message),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),[cljs.core.str("at line "),cljs.core.str(line)].join('')),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),file)], null));
goog.events.listen(G__7988,goog.events.EventType.CLICK,((function (G__7988,map__7986,map__7986__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__7988,map__7986,map__7986__$1,data,message,line,file))
);
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__7989){
var map__7993 = p__7989;
var map__7993__$1 = ((((!((map__7993 == null)))?((((map__7993.cljs$lang$protocol_mask$partition0$ & (64))) || (map__7993.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7993):map__7993);
var messages = map__7993__$1;
var warnings = cljs.core.get.call(null,map__7993__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__7993__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__7995 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__7995,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),goog.dom.htmlToDocumentFragment(adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__7995,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__7996){
var map__7999 = p__7996;
var map__7999__$1 = ((((!((map__7999 == null)))?((((map__7999.cljs$lang$protocol_mask$partition0$ & (64))) || (map__7999.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7999):map__7999);
var messages = map__7999__$1;
var warnings = cljs.core.get.call(null,map__7999__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__7999__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__7999,map__7999__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__7999,map__7999__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__7999,map__7999__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__7999,map__7999__$1,messages,warnings,exception))
;
